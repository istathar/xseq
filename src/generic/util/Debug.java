...
public class Debug
{
     ...
     * @returns A new String[] containing the command line without the debug
     ...
     * -Ddebug= option to a Java VM)]. It is also called by the other {@link
     * Debug.init(String[])}constructor if you choose to use that to process
     * the command line arguments. You can also call it explicitly on your
     * own.
     * 
     * @param groups
    ...
    /**
     * @param type
     *            A string name for the group of debug messages to be
     *            activated
     */
