...
/**
 * A simple exception to use to indicate the code did something unexpected
 * while being initially authored. Code should not ship with any
 * DebugExceptions present - if it's a real exception, then change it to
 * something more appropriate and trap it properly.
 * 
 * @author Andrew Cowie
 */
