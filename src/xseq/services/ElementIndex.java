 ...
 * String IDs are the heart of the xseq system. This class builds and maintains
 * a [admittely simple] lookup table between these IDs and the DOM Elements they
 * point to.
 * 
 * <P>
 * Note that
 ...
 * </PRE>
 * 
 * doesn't work worth a damn. This seems to always return null; I poked through
 * the sources, and I've got a hunch that it may well be unimplemented - they
 * may be trapping an excpetion internally.
 * 
 * So, instead, we will manually implement a search care of this class, which we
 * were going to end up needing anyway.
 * 
...
public class ElementIndex
{
	 ...
	 * 
	 * @param doc
	 *            a DOM Document in which the id attributes were already present
	 *            or were added by the routines in XmlUtils.
	 */
